...
def get_response(text,llm_model="gpt-4"):
    """
    使用LLM对内容进行分析
    """
    messages=[
...
def process_text(text, llm_model="gpt-4"):
    """
    单条文本的处理
    """
...
def process_texts_from_file(input_file, output_file, value_file, llm_model="gpt-4"):
    """
    使用多线程处理文本
    """
...
if __name__ == "__main__":
    ...
    data_dir = r'./dataset/data'
    
    input_file = "QA_with_metadata.json"
    output_file = "QA_filtered.json"
    value_file = "QA_filtered_values.json"
